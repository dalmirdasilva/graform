...
\begin{document}
  ...
  \clearpage
    ...
    \footnotetext[1]{Apenas parcialmente, somente é possível definir a próxima página do formulário baseado na resposta.}
  ...
  \section{Testes do sistema}
    ...
    \begin{figure}[h!]
      \centering
      \includegraphics[width=.5\textwidth]{model_test.png}
  ...
  \section{Conclusão}
    ...
    de cobertura de código, embora tenha sido difícil segui-la {\em by the book.}
    Assim como o uso do padrão MVC ajudou no objetivo de atingir baixo acoplamento
