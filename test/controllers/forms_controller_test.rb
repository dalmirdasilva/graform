...
class FormsControllerTest < ActionController::TestCase
  ...
  test "should create form" do
    assert_difference('Form.count') do
      post :create, form: { description: @form.description, name: @form.name, user_id: @form.user_id }
    end
  ...
  test "should update form" do
    patch :update, id: @form, form: { description: @form.description, name: @form.name, user_id: @form.user_id }
    assert_redirected_to form_path(assigns(:form))
  end
